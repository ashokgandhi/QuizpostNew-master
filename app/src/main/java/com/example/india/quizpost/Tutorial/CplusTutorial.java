package com.example.india.quizpost.Tutorial;
...
import com.example.india.quizpost.ProjectClassFile.TutorialActivity;
...
public class CplusTutorial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cplus_tutorial);
    ...
    void register() {
        Intent intent = new Intent(CplusTutorial.this, TutorialActivity.class);
